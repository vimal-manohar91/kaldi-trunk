...
if [ $# -ne 5 ]; then
  echo "Usage: $0 [options] <data-dir> <lang-dir> <model-dir> <temp-dir> <out-data-dir>"
  echo " Options:"
  ...
  echo 
  echo "e.g.:"
  echo "$0 data/dev10h data/lang exp/tri4b_seg exp/tri4b_resegment_dev10h data/dev10h.seg"
  exit 1
fi
